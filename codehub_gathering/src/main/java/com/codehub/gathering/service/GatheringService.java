package com.codehub.gathering.service;

import com.codehub.gathering.dao.GatheringDao;
...
public class GatheringService {
	 ...
	 * @param gathering
	 *
	 * @CacheEvict 清除Spring Cache的缓存,根据#gathering.id删除
	 */
	 ...
	 * @param id
	 *
	 * @CacheEvict 清除Spring Cache的缓存,根据#id删除
	 */
