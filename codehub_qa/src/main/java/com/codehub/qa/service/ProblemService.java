package com.codehub.qa.service;

import com.codehub.qa.dao.ProblemDao;
...
public class ProblemService {
    ...
    public Page<Problem> newlist(String labelid, int page, int size) {
		...
		return problemDao.findByLabelid(labelid, pageable);
    }
	...
	public Page<Problem> hotlist(String labelid, int page, int size) {
		//创建分页对象
		Pageable pageable = PageRequest.of(page - 1, size);
		return problemDao.findByHotListLabelid(labelid, pageable);
	}
	...
	public Page<Problem> waitlist(String labelid, int page, int size) {
		//创建分页对象
		Pageable pageable = PageRequest.of(page - 1, size);
		return problemDao.findByWaitListLabelid(labelid, pageable);
	}
}
